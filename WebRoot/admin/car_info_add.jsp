                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        <form id="formId" class="form-horizontal" action="${pageContext.request.contextPath}/car/car_info_add.action" method="post" enctype="multipart/form-data">
                             
                                                <div class="form-group"><label class="col-sm-2 control-label">品牌:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="branch"></div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">年代:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="year"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">配置:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="configure"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">座位数:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="size"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">燃油标号:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="fuel"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">排量:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="gus"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">变速箱类型:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="speed"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">驱动方式:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="drive"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">GPS:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="GPS"></div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">数量:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="amount"></div>
                                            </div>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button id="submitId" class="btn btn-primary" type="submit">保存</button>
                                    </div>
                                </div>
	...
	$(function(){
		...
		$("#submitId").click(
			...
			alert("11");
				...
				$.ajax({
					type:"POST",
					url:"${pageContext.request.contextPath}/car/car_info_add.action",
					data:form,
					processData:false,
                	contentType:false,
                	async : false,
